module config_gaussian_hill_mod
...
type, public, extends(config_t) :: config_gaussian_hill_t
...
end type config_gaussian_hill_t
...
subroutine parse(this, config_string)
    ...
    class(config_gaussian_hill_t), intent(inout) :: this
    ...
    namelist /gaussian_hill/ grav, omega, h_mean, a, u0

    read(config_string, gaussian_hill)
...
end module config_gaussian_hill_mod
