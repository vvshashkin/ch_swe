...
type, extends(tile_quadrature_t) :: default_tile_quadrature_t
    contains
        ...
        procedure, public :: l2norm => calc_tile_l2norm_default
...
end function calc_tile_mass_default
...
end function calc_tile_dot_default

function calc_tile_l2norm_default(this, f, mesh) result(l2norm)
    ...
    do k = mesh%ks, mesh%ke
        do j = mesh%js, mesh%je
            do i = mesh%is, mesh%ie
                l2norm = l2norm + f%p(i,j,k)**2*mesh%J(i,j,k)*mesh%hx*mesh%hy
            end do
        end do
    end do

end function calc_tile_l2norm_default
