...
contains
    ...
    procedure, public :: assign_v1         => assign_stvec_v1 !v = s1
...
subroutine assign_stvec_v1(this, v1, domain)

    class(stvec_t),      intent(inout) :: this
    class(stvec_t),      intent(in)    :: v1
    class(domain_t),     intent(in)    :: domain

    call parcomm_global%abort("assign_stvec_v1 not implemented for specific stvec class")

end subroutine assign_stvec_v1
...
function compute_stvec_maxabs(this, domain) result(maxabs)
    ...
    maxabs = 0.0_8
    call parcomm_global%abort("compute_stvec_maxabs not implemented for specific stvec class")

end function compute_stvec_maxabs
