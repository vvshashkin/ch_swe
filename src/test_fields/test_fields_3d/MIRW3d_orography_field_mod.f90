module MIRW3d_orography_field_mod
...
real(kind=8), parameter :: phi0 = pi/6.0_8, lam0 = 0.5_8*pi

type, extends(vector_field3d_t) :: MIRW3d_orography_grad_t
    real(kind=8) :: h0, scale
    real(kind=8) :: d0 = 1500e3_8
    contains
    procedure :: get_vector_component_tile
end type MIRW3d_orography_grad_t

type, extends(scalar_field3d_t) :: MIRW3d_orography_field_t
    real(kind=8) :: h0, scale, d0 = 1500e3_8
    contains
    procedure :: get_scalar_field_tile
end type MIRW3d_orography_field_t
...
subroutine get_vector_component_tile(this,v,mesh,halo_width, &
    ...
    class(MIRW3d_orography_grad_t), intent(in)    :: this
    ...
    do k=ks,ke
        do j=js,je
            do i=is,ie
                ...
                dh_dd =-2.0_8*this%h0*exp(-d**2/this%d0**2)*d/this%d0**2
...
subroutine get_scalar_field_tile(this,f,mesh,halo_width)
    class(MIRW3d_orography_field_t), intent(in)    :: this
    ...
    do k=ks,ke
        do j=js,je
            do i=is,ie
                ...
                f%p(i,j,k) = this%h0*exp(-d**2/this%d0**2)
            end do
        end do
    end do
...
end module MIRW3d_orography_field_mod
