...
subroutine calc_diff_vec_xyz(this, u_tend, v_tend, u, v, domain)
    ...
    call cube2cart_vec(this%vx, this%vy, this%vz, u, v, domain%mesh_u, this%components_type)
    ...
    call cart2cube_vec(u_tend, v_tend, this%vx_tend, this%vy_tend, this%vz_tend, domain%mesh_u, this%components_type)
