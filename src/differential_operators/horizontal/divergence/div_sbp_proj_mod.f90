...
type, public, extends(div_operator_t) :: div_sbp_proj_t
    type(grid_field_t)             :: Ju, Jv, Dx, Dy
...
end type div_sbp_proj_t

contains

subroutine calc_div(this, div, u, v, domain)

    class(div_sbp_proj_t), intent(inout) :: this
    ...
    call this%proj_op%get_halo_scalar(div, domain, 1)
