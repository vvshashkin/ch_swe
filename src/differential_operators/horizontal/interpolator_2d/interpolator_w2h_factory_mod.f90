...
subroutine create_w2h_interpolator(interpolator_w2h, sbp_i2c_interp_name, domain)
    ...
    case ("W21_stagered_interp_i2c")
        interpolator_w2h%sbp_interp_w2v = sbp_interp_i2c_21_t()
    ...
    case ("W42_stagered_interp_i2c")
        interpolator_w2h%sbp_interp_w2v = sbp_interp_i2c_42_t()
        call create_vec2vec_interpolator2d(interpolator_w2h%interp_v2h_op, "interp2d_uv2pvec_C_sbp42", domain)
    case ("W63_stagered_interp_i2c")
        interpolator_w2h%sbp_interp_w2v = sbp_interp_i2c_63_t()
        call create_vec2vec_interpolator2d(interpolator_w2h%interp_v2h_op, "interp2d_uv2pvec_C_sbp63", domain)
    case default
