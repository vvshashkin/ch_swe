...
type, public, abstract :: sbp_interp_t
contains
...
end type sbp_interp_t

abstract interface
    subroutine apply_tile_i(this, f_out, f_in, mesh, direction)
        import :: sbp_interp_t, tile_field_t, tile_mesh_t
        class(sbp_interp_t),  intent(in)    :: this
